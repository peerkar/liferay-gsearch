...
public class GSearchKeywordSuggesterImpl implements GSearchKeywordSuggester {
	...
	public String[] getSuggestionsAsStringArray(PortletRequest portletRequest)
		...
		String[] configuration = _configurationHelper.getKeywordSuggesterConfiguration();
		...
		// be that there are no fields yet. This might throw a harmless exception.
	...
	protected Suggester getCompletionSuggester(
		...
		String fieldName = _configurationHelper.parseConfigurationVariables(
			portletRequest, null, configuration.getString("field_name"));
