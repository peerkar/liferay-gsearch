...
/**
 * Class for building query params object from request parameters.
 * 
...
public class QueryParamsBuilder {
	...
	protected void setSortParam() {
		...
		if ("title".equals(sortField)) {
			field = "localized_title_" + _queryParams.getLocale().toString() + "_sortable";
		}
		else {
	...
	protected void setStartEndParams() {
		...
		int start =
			ParamUtil.getInteger(_resourceRequest, GSearchWebKeys.START, 0);
