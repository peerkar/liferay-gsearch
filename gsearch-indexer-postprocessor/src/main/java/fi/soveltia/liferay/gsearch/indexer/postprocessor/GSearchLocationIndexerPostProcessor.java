...
package fi.soveltia.liferay.gsearch.indexer.postprocessor;
...
import fi.soveltia.liferay.gsearch.indexer.configuration.ModuleConfiguration;
...
@Component(
	configurationPid = "fi.soveltia.liferay.gsearch.indexer.postprocessor.configuration.GSearchIndexerPostprocessor",
	immediate = true,
	property = {
...
public class GSearchLocationIndexerPostProcessor
	...
	public void postProcessDocument(Document document, Object obj)
		...
		document.addGeoLocation(_moduleConfiguration.fieldName(), latitude, longitude);
	}
