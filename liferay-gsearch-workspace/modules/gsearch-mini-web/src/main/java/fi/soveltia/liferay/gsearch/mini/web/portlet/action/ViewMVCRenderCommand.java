...
public class ViewMVCRenderCommand implements MVCRenderCommand {
	...
	/**
	 * Gets current friendly URL without any parameters.
	 * 
	 * @param renderRequest
	 * @return
	 */
	private String _getCurrentFriendlyURL(RenderRequest renderRequest) {
	...
	/**
	 * Sets request attributes, like configuration.
	 * 
	 * @param renderRequest
	 * @param renderResponse
	 */
	private void _setRequestAttributes(RenderRequest renderRequest, RenderResponse renderResponse) {
		...
		for (String page : hiddenPages) {
			if (_getCurrentFriendlyURL(renderRequest).equals(page)) {
		...
		renderRequest.setAttribute(
			GSearchMiniWebKeys.REQUEST_DELAY,
