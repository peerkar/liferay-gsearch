 ...
 * @see ClicksServiceSoap
 * @generated
 */
@ProviderType
public class ClicksServiceHttp {
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				ClicksServiceUtil.class, "getClicks",
				_getClicksParameterTypes0);
	...
	private static Log _log = LogFactoryUtil.getLog(ClicksServiceHttp.class);

	private static final Class<?>[] _getClicksParameterTypes0 = new Class[] {
		int.class, int.class
	};
