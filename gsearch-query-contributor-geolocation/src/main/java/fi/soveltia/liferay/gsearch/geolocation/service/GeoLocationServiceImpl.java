package fi.soveltia.liferay.gsearch.querycontributor.geolocation.service;
...
public class GeoLocationServiceImpl implements GeoLocationService {
	 ...
	 */
	@Override
	public Float[] getCoordinates(String ipAddress) throws IOException, JSONException {
